...
- Run a subset of tests on a single Python version: `nox -p 3.13 -s pytest -- tests/suspendtest/core/state_store`
...
- Subclass and raise `SuspendTestError` to provide user-actionable error messages with clear next steps.
- Tests are organized to mirror the source structure
- Integration tests in `tests/suspendtest/cli/` test full CLI workflows
- Mock external dependencies (e.g. using `unittest.mock`)

## how to use python-can
document path: `/home/an/workspace/python/python-can/doc`
